...
public class Operacoes {
	...
	public Usuario registrarConta(int userID, ArrayList<Usuario> usuarios) {
	    ...
	    Usuario usuario = new Usuario(userID, dados.get(0), dados.get(1), dados.get(2), dados.get(3), dados.get(4), dados.get(5), dados.get(6), dados.get(7), dados.get(8), dados.get(9), dados.get(10), dados.get(11), dados.get(12));
